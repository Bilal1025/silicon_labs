...
class _ScanScreenState extends State<ScanScreen> {
  ...
  Future onScanPressed() async {
    try {
      ...
      await FlutterBluePlus.startScan(timeout: const Duration(seconds: 15), continuousUpdates: true, continuousDivisor: divisor);
    } catch (e) {
  ...
  void onConnectPressed(BluetoothDevice device) {
    ...
    MaterialPageRoute route = MaterialPageRoute(builder: (context) => ViewActivity(device: device), settings: const RouteSettings(name: '/DeviceScreen'));
        ...
        .map(
          (d) => ConnectedDeviceTile(
            ...
            onOpen: () => Navigator.of(context).push(
              MaterialPageRoute(
                builder: (context) => ViewActivity(device: d),
