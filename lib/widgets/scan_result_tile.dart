...
class _ScanResultTileState extends State<ScanResultTile> {
  ...
  String getNiceManufacturerData(Map<int, List<int>> data) {
    return data.entries.map((entry) => '${entry.key.toRadixString(16)}: ${getNiceHexArray(entry.value)}').join(', ').toUpperCase();
  }
  ...
  Widget build(BuildContext context) {
    ...
    return ExpansionTile(
      ...
      children: <Widget>[
        ...
        if (adv.manufacturerData.isNotEmpty) _buildAdvRow(context, 'Manufacturer Data', getNiceManufacturerData(adv.manufacturerData)),
