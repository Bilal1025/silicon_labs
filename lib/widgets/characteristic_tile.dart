...
class _CharacteristicTileState extends State<CharacteristicTile> {
  ...
  Widget buildReadButton(BuildContext context) {
    return TextButton(
        ...
        onPressed: () async {
          widget.onReadPressed != null ? widget.onReadPressed!() : await onReadPressed();
          setState(() {});
        });
  }
  ...
  Widget buildWriteButton(BuildContext context) {
    ...
    return TextButton(
        ...
        onPressed: () async {
          widget.onWritePressed != null ? await widget.onWritePressed!(data) : await onWritePressed();
          setState(() {});
        });
  }
  ...
  Widget buildSubscribeButton(BuildContext context) {
    ...
    return TextButton(
        ...
        onPressed: () async {
          widget.onNotificationPressed != null ? widget.onNotificationPressed!() : await onSubscribePressed();
          setState(() {});
        });
  }
